...
class PoseEstimator:
    ...
    def draw_mouth(self,img,points):
        mouth_pt1 = (int(points[4][0]),int(points[4][1]))
        mouth_pt2 = (int(points[5][0]),int(points[5][1]))
        mouth_pt3 = (int(points[15][0]),int(points[15][1]))
        mouth_pt4 = (int(points[47][0]),int(points[47][1]))
        olo = (mouth_pt1,mouth_pt2,mouth_pt3,mouth_pt4)
        for i in olo:
            cv2.circle(img,i,4,(200,0,50),-1)
